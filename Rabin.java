...
public class Rabin extends javax.swing.JFrame implements ActionListener{     
    long codigoPassado[];
    long p,q,x,y;
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Rabin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
